...
namespace Media.WebApi.Internal.Loggers;

internal static class OperationReaderScopeLogger
{
    private static readonly Logger Logger = LogManager.GetLogger(nameof(OperationReaderScopeLogger));
